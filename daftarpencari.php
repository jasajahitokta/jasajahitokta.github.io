...
include "page/include/connect.php";
	if(!empty($_REQUEST[daftarpencari])==1)
		{
		$pass = md5($_REQUEST[pass]);
		$q1 = mysql_query("INSERT INTO pencari SET nama='$_REQUEST[nama]',wa='$_REQUEST[wa]',pass='$pass'");
...
<html>
<head>	
	<title>Daftar Pencari | Cari Jasa Penjahit Terdekat</title>
...
<body>
	<div class="login-wrap customscroll d-flex align-items-center flex-wrap justify-content-center pd-20">
		<div class="login-box bg-white box-shadow pd-30 border-radius-5">
			<h5 style="text-align:center" class="text-danger"><b>DAFTAR PENCARI</b></h5>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="input-group">
							<input type="hidden" name="daftarpencari" value="1">
							<button class="btn btn-warning btn-block" type="submit" value="">Daftar</button>
						</div>
					</div>
					<div class="col-sm-12">
						<p style="font-size:12px">Jika anda sudah pernah mendaftar, anda dapat lamgsung masuk melalui halaman login. Silahakn Klik Tomobol "Login" dibawah ini.</p>
						<div class="input-group">
